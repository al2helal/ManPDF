...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_find\_structure\_from\_oid(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{asn1\_find\_structure\_from\_oid(3)}
\author{}
\date{}
...
\toprule\addlinespace
asn1\_find\_structure\_from\_oid(3) & libtasn1 &
asn1\_find\_structure\_from\_oid(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_find\_structure\_from\_oid - API function
...
\textbf{const char *
asn1\_find\_structure\_from\_oid(asn1\_node}\emph{definitions}\textbf{,
const char *}\emph{oidValue}\textbf{);}
...
\textbf{NULL} when \emph{oidValue} not found, otherwise the pointer to a
constant string that contains the element name defined just after the
OID.

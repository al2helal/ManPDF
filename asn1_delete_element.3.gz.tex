...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_delete\_element(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\toprule\addlinespace
asn1\_delete\_element(3) & libtasn1 & asn1\_delete\_element(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_delete\_element - API function
...
\textbf{int asn1\_delete\_element(asn1\_node}\emph{structure}\textbf{,
const char *}\emph{element\_name}\textbf{);}
...
\begin{description}
\itemsep1pt\parskip0pt\parsep0pt
\item[const char * element\_name]
element's name you want to delete.
\end{description}

\hyperdef{}{DESCRIPTION}{\section{\hyperref[DESCRIPTION]{DESCRIPTION}}\label{DESCRIPTION}}

Deletes the element named * \emph{element\_name} inside *
\emph{structure} .
...
if the \emph{element\_name} was not found.

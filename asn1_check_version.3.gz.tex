...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_check\_version(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\toprule\addlinespace
asn1\_check\_version(3) & libtasn1 & asn1\_check\_version(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_check\_version - API function
...
\textbf{const char * asn1\_check\_version(const char
*}\emph{req\_version}\textbf{);}

\hyperdef{}{ARGUMENTS}{\section{\hyperref[ARGUMENTS]{ARGUMENTS}}\label{ARGUMENTS}}

\begin{description}
\itemsep1pt\parskip0pt\parsep0pt
\item[const char * req\_version]
Required version number, or \textbf{NULL}.
\end{description}

\hyperdef{}{DESCRIPTION}{\section{\hyperref[DESCRIPTION]{DESCRIPTION}}\label{DESCRIPTION}}

Check that the version of the library is at minimum the requested one
and return the version string; return \textbf{NULL} if the condition is
not satisfied. If a \textbf{NULL} is passed to this function, no check
is done, but the version string is simply returned.

~

See \textbf{ASN1\_VERSION} for a suitable \emph{req\_version} string.

\hyperdef{}{RETURNS}{\section{\hyperref[RETURNS]{RETURNS}}\label{RETURNS}}

Version string of run-time library, or \textbf{NULL} if the run-time
library does not meet the required version number.

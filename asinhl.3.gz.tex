...
The \textbf{asinh}() function calculates the inverse hyperbolic sine of
\emph{x}; that is the value whose hyperbolic sine is \emph{x}.
...
If \emph{x} is positive infinity (negative infinity), positive infinity
...
\textbf{acosh}(3), \textbf{atanh}(3), \textbf{casinh}(3),

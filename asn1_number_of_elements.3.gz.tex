...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_number\_of\_elements(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{asn1\_number\_of\_elements(3)}
\author{}
\date{}
...
\toprule\addlinespace
asn1\_number\_of\_elements(3) & libtasn1 & asn1\_number\_of\_elements(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_number\_of\_elements - API function
...
\textbf{int
asn1\_number\_of\_elements(asn1\_node}\emph{element}\textbf{, const char
*}\emph{name}\textbf{, int *}\emph{num}\textbf{);}
...
Counts the number of elements of a sub-structure called NAME with names
equal to ``?1'',``?2'', \ldots{}
...
if \\ \emph{name} is not known, \textbf{ASN1\_GENERIC\_ERROR} if pointer
\emph{num} is \textbf{NULL}.

...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_expand\_octet\_string(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{asn1\_expand\_octet\_string(3)}
\author{}
\date{}
...
\toprule\addlinespace
asn1\_expand\_octet\_string(3) & libtasn1 &
asn1\_expand\_octet\_string(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_expand\_octet\_string - API function
...
\textbf{int
asn1\_expand\_octet\_string(asn1\_node}\emph{definitions}\textbf{,
asn1\_node *}\emph{element}\textbf{, const char
*}\emph{octetName}\textbf{, const char *}\emph{objectName}\textbf{);}
...
\begin{description}
\itemsep1pt\parskip0pt\parsep0pt
\item[const char * octetName]
name of the OCTECT STRING field to expand.
\end{description}

\begin{description}
\itemsep1pt\parskip0pt\parsep0pt
\item[const char * objectName]
name of the OBJECT IDENTIFIER field to use to define the type for
expansion.
\end{description}
...
decoding process (the \textbf{asn1\_der\_decoding()} function). The type
...
\textbf{ASN1\_ELEMENT\_NOT\_FOUND} if \emph{objectName} or
\emph{octetName} are not correct, \textbf{ASN1\_VALUE\_NOT\_VALID} if it
wasn't possible to find the type to use for expansion, or other errors

...
\toprule\addlinespace
asn1\_strerror(3) & libtasn1 & asn1\_strerror(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
\textbf{const char * asn1\_strerror(int}\emph{error}\textbf{);}
...
similar to strerror. The only difference is that it accepts an error
(number) returned by a libtasn1 function.

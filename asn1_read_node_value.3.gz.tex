...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_read\_node\_value(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{asn1\_read\_node\_value(3)}
\author{}
\date{}
...
\toprule\addlinespace
asn1\_read\_node\_value(3) & libtasn1 & asn1\_read\_node\_value(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_read\_node\_value - API function
...
\textbf{int asn1\_read\_node\_value(asn1\_node}\emph{node}\textbf{,
asn1\_data\_node\_st *}\emph{data}\textbf{);}

\hyperdef{}{ARGUMENTS}{\section{\hyperref[ARGUMENTS]{ARGUMENTS}}\label{ARGUMENTS}}

\begin{description}
\itemsep1pt\parskip0pt\parsep0pt
\item[asn1\_node node]
pointer to a node.
\end{description}

\begin{description}
\itemsep1pt\parskip0pt\parsep0pt
\item[asn1\_data\_node\_st * data]
a point to a asn1\_data\_node\_st
\end{description}

\hyperdef{}{DESCRIPTION}{\section{\hyperref[DESCRIPTION]{DESCRIPTION}}\label{DESCRIPTION}}

Returns the value a data node inside a asn1\_node structure. The data
returned should be handled as constant values.

\hyperdef{}{RETURNS}{\section{\hyperref[RETURNS]{RETURNS}}\label{RETURNS}}

\textbf{ASN1\_SUCCESS} if the node exists.

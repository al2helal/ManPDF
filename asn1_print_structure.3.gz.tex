...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_print\_structure(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\toprule\addlinespace
asn1\_print\_structure(3) & libtasn1 & asn1\_print\_structure(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_print\_structure - API function
...
\textbf{void asn1\_print\_structure(FILE *}\emph{out}\textbf{,
asn1\_node}\emph{structure}\textbf{, const char *}\emph{name}\textbf{,
int}\emph{mode}\textbf{);}
...
\textbf{ASN1\_PRINT\_NAME}, \textbf{ASN1\_PRINT\_NAME\_TYPE},
\textbf{ASN1\_PRINT\_NAME\_TYPE\_VALUE}, or \textbf{ASN1\_PRINT\_ALL}.
\end{description}

\hyperdef{}{DESCRIPTION}{\section{\hyperref[DESCRIPTION]{DESCRIPTION}}\label{DESCRIPTION}}

Prints on the \emph{out} file descriptor the structure's tree starting
from the \emph{name} element inside the structure \emph{structure} .

...
\toprule\addlinespace
asn1\_bit\_der(3) & libtasn1 & asn1\_bit\_der(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
\textbf{void asn1\_bit\_der(const unsigned char *}\emph{str}\textbf{,
int}\emph{bit\_len}\textbf{, unsigned char *}\emph{der}\textbf{, int
*}\emph{der\_len}\textbf{);}
...
\itemsep1pt\parskip0pt\parsep0pt
\item[int * der\_len]
number of meaningful bytes of DER (der{[}0{]}..der{[}ans\_len-1{]}).
\end{description}

\hyperdef{}{DESCRIPTION}{\section{\hyperref[DESCRIPTION]{DESCRIPTION}}\label{DESCRIPTION}}

Creates a length-value DER encoding for the input data as it would have
been for a BIT STRING. The DER encoded data will be copied in \emph{der}
.

...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_get\_length\_ber(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\toprule\addlinespace
asn1\_get\_length\_ber(3) & libtasn1 & asn1\_get\_length\_ber(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_get\_length\_ber - API function
...
\textbf{long asn1\_get\_length\_ber(const unsigned char
*}\emph{ber}\textbf{, int}\emph{ber\_len}\textbf{, int
*}\emph{len}\textbf{);}
...
\textbf{asn1\_get\_length\_der()} is that this function will return a
length even if the value has indefinite encoding.

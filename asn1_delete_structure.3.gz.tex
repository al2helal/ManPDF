...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_delete\_structure(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{asn1\_delete\_structure(3)}
\author{}
\date{}
...
\toprule\addlinespace
asn1\_delete\_structure(3) & libtasn1 & asn1\_delete\_structure(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_delete\_structure - API function
...
\textbf{int asn1\_delete\_structure(asn1\_node
*}\emph{structure}\textbf{);}

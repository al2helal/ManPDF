...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_get\_bit\_der(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\toprule\addlinespace
asn1\_get\_bit\_der(3) & libtasn1 & asn1\_get\_bit\_der(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_get\_bit\_der - API function
...
\textbf{int asn1\_get\_bit\_der(const unsigned char
*}\emph{der}\textbf{, int}\emph{der\_len}\textbf{, int
*}\emph{ret\_len}\textbf{, unsigned char *}\emph{str}\textbf{,
int}\emph{str\_size}\textbf{, int *}\emph{bit\_len}\textbf{);}
...
Return \textbf{ASN1\_SUCCESS} on success, or an error.

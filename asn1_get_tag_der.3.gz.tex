...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={asn1\_get\_tag\_der(3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\toprule\addlinespace
asn1\_get\_tag\_der(3) & libtasn1 & asn1\_get\_tag\_der(3)
\\\addlinespace
\bottomrule
\end{longtable}
...
asn1\_get\_tag\_der - API function
...
\textbf{int asn1\_get\_tag\_der(const unsigned char
*}\emph{der}\textbf{, int}\emph{der\_len}\textbf{, unsigned char
*}\emph{cls}\textbf{, int *}\emph{len}\textbf{, unsigned long
*}\emph{tag}\textbf{);}
